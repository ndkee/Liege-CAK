...
/* ------------------------------------------------------------
  ...
  #if CAK == YES
  data->gL = ARRAY_4D(COMPONENTS, NX3_TOT, NX2_TOT, NX1_TOT, double);
  #endif
...
--------------------------------------*/
    ...
    data->gidir                            = ARRAY_3D(NX3_TOT, NX2_TOT, NX1_TOT, double);
    data->gjdir                            = ARRAY_3D(NX3_TOT, NX2_TOT, NX1_TOT, double);
    data->gkdir                            = ARRAY_3D(NX3_TOT, NX2_TOT, NX1_TOT, double);

    data->y1d                              = ARRAY_1D((int)fabs(g_inputParam[CAK3D_nyy]), double);
    data->wy1d                             = ARRAY_1D((int)fabs(g_inputParam[CAK3D_nyy]), double);
    data->pp1d                             = ARRAY_1D((int)fabs(2*g_inputParam[CAK3D_npp]), double);
    data->wpp1d                            = ARRAY_1D((int)fabs(2*g_inputParam[CAK3D_npp]), double);
    data->fw                               = ARRAY_4D((int)fabs(2*g_inputParam[CAK3D_npp]*g_inputParam[CAK3D_nyy]), NX3_TOT, NX2_TOT, NX1_TOT, double);

    data->iminv                            = ARRAY_1D(NX2_TOT, int);
    data->jmaxv                            = ARRAY_1D(NX1_TOT, int);

    data->ctpmax                           = ARRAY_3D((int)fabs(2*g_inputParam[CAK3D_npp]), NX2_TOT, NX1_TOT, double);
